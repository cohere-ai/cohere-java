...
@JsonDeserialize(builder = ChatRequestResponseFormat.Builder.class)
public final class ChatRequestResponseFormat {
    private final ChatRequestResponseFormatType type;

    private final Optional<Map<String, Object>> schema;

    private final Map<String, Object> additionalProperties;

    private ChatRequestResponseFormat(
            ChatRequestResponseFormatType type,
     ...
     */
    @JsonProperty("type")
    public ChatRequestResponseFormatType getType() {
        return type;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatRequestResponseFormat && equalTo((ChatRequestResponseFormat) other);
    }
    ...
    private boolean equalTo(ChatRequestResponseFormat other) {
    ...
    public interface TypeStage {
        _FinalStage type(ChatRequestResponseFormatType type);

        Builder from(ChatRequestResponseFormat other);
    }

    public interface _FinalStage {
        ChatRequestResponseFormat build();
    ...
    public static final class Builder implements TypeStage, _FinalStage {
        private ChatRequestResponseFormatType type;
        ...
        @java.lang.Override
        public Builder from(ChatRequestResponseFormat other) {
            type(other.getType());
        ...
        @java.lang.Override
        @JsonSetter("type")
        public _FinalStage type(ChatRequestResponseFormatType type) {
            this.type = type;
            return this;
        }
        ...
        @java.lang.Override
        public ChatRequestResponseFormat build() {
            return new ChatRequestResponseFormat(type, schema, additionalProperties);
        }
    }
}
