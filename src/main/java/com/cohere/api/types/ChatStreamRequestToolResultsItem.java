...
@JsonDeserialize(builder = ChatStreamRequestToolResultsItem.Builder.class)
public final class ChatStreamRequestToolResultsItem {
    ...
    private ChatStreamRequestToolResultsItem(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatStreamRequestToolResultsItem && equalTo((ChatStreamRequestToolResultsItem) other);
    }
    ...
    private boolean equalTo(ChatStreamRequestToolResultsItem other) {
    ...
    public interface CallStage {
        ...
        Builder from(ChatStreamRequestToolResultsItem other);
    }

    public interface _FinalStage {
        ChatStreamRequestToolResultsItem build();
    ...
    public static final class Builder implements CallStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ChatStreamRequestToolResultsItem other) {
            call(other.getCall());
        ...
        @java.lang.Override
        public ChatStreamRequestToolResultsItem build() {
            return new ChatStreamRequestToolResultsItem(call, outputs, additionalProperties);
        }
    }
}
