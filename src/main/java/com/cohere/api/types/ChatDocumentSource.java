...
@JsonDeserialize(builder = ChatDocumentSource.Builder.class)
public final class ChatDocumentSource {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatDocumentSource && equalTo((ChatDocumentSource) other);
    }
    ...
    public static final class Builder {
        ...
        public ChatDocumentSource build() {
            return new ChatDocumentSource(id, document, additionalProperties);
        }
    }
}
