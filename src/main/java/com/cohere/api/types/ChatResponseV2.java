...
@JsonDeserialize(builder = ChatResponseV2.Builder.class)
public final class ChatResponseV2 {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatResponseV2 && equalTo((ChatResponseV2) other);
    }
    ...
    private boolean equalTo(ChatResponseV2 other) {
    ...
    public interface IdStage {
        ...
        Builder from(ChatResponseV2 other);
    }
    ...
    public static final class Builder implements IdStage, FinishReasonStage, MessageStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ChatResponseV2 other) {
            id(other.getId());
        ...
        @java.lang.Override
        public ChatResponseV2 build() {
            return new ChatResponseV2(id, finishReason, prompt, message, usage, logprobs, additionalProperties);
        }
    }
}
