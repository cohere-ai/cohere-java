...
@JsonDeserialize(builder = ChatRequestSearchOptions.Builder.class)
public final class ChatRequestSearchOptions {
    ...
    private ChatRequestSearchOptions(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatRequestSearchOptions && equalTo((ChatRequestSearchOptions) other);
    }
    ...
    private boolean equalTo(ChatRequestSearchOptions other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ChatRequestSearchOptions other) {
        ...
        public ChatRequestSearchOptions build() {
            return new ChatRequestSearchOptions(model, temperature, maxTokens, preamble, seed, additionalProperties);
        }
    }
}
