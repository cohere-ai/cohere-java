...
public final class EmbedContent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EmbedContent && value.equals(((EmbedContent) other).value);
    }
    ...
    public interface Visitor<T> {
        T visitImageUrl(EmbedImage imageUrl);

        T visitText(EmbedText text);

        T _visitUnknown(Object unknownType);
    }

    @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type", visible = true, defaultImpl = _UnknownValue.class)
    @JsonSubTypes({@JsonSubTypes.Type(ImageUrlValue.class), @JsonSubTypes.Type(TextValue.class)})
    ...
    private static final class ImageUrlValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "EmbedContent{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "EmbedContent{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
