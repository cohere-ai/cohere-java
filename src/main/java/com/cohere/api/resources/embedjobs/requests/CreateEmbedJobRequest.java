...
public final class CreateEmbedJobRequest {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.model, this.datasetId, this.inputType, this.name, this.truncate);
    }
    ...
    public static final class Builder implements ModelStage, DatasetIdStage, InputTypeStage, _FinalStage {
        ...
        public CreateEmbedJobRequest build() {
            return new CreateEmbedJobRequest(model, datasetId, inputType, name, truncate, additionalProperties);
        }
    }
}
