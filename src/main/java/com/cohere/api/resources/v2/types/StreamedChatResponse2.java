...
public final class StreamedChatResponse2 {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private StreamedChatResponse2(Value value) {
        this.value = value;
    }
    ...
    public static StreamedChatResponse2 messageStart(ChatMessageStartEvent value) {
        return new StreamedChatResponse2(new MessageStartValue(value));
    }

    public static StreamedChatResponse2 contentStart(ChatContentStartEvent value) {
        return new StreamedChatResponse2(new ContentStartValue(value));
    }

    public static StreamedChatResponse2 contentDelta(ChatContentDeltaEvent value) {
        return new StreamedChatResponse2(new ContentDeltaValue(value));
    }

    public static StreamedChatResponse2 contentEnd(ChatContentEndEvent value) {
        return new StreamedChatResponse2(new ContentEndValue(value));
    }

    public static StreamedChatResponse2 toolPlanDelta(ChatToolPlanDeltaEvent value) {
        return new StreamedChatResponse2(new ToolPlanDeltaValue(value));
    }

    public static StreamedChatResponse2 toolCallStart(ChatToolCallStartEvent value) {
        return new StreamedChatResponse2(new ToolCallStartValue(value));
    }

    public static StreamedChatResponse2 toolCallDelta(ChatToolCallDeltaEvent value) {
        return new StreamedChatResponse2(new ToolCallDeltaValue(value));
    }

    public static StreamedChatResponse2 toolCallEnd(ChatToolCallEndEvent value) {
        return new StreamedChatResponse2(new ToolCallEndValue(value));
    }

    public static StreamedChatResponse2 citationStart(CitationStartEvent value) {
        return new StreamedChatResponse2(new CitationStartValue(value));
    }

    public static StreamedChatResponse2 citationEnd(CitationEndEvent value) {
        return new StreamedChatResponse2(new CitationEndValue(value));
    }

    public static StreamedChatResponse2 messageEnd(ChatMessageEndEvent value) {
        return new StreamedChatResponse2(new MessageEndValue(value));
    }
    ...
    private static final class MessageStartValue implements Value {
        ...
        public String toString() {
            return "StreamedChatResponse2{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "StreamedChatResponse2{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
