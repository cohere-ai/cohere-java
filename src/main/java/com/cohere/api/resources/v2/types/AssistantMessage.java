...
public final class AssistantMessage {
    private final Optional<List<ToolCall2>> toolCalls;
    ...
    private AssistantMessage(
            Optional<List<ToolCall2>> toolCalls,
    ...
    public Optional<List<ToolCall2>> getToolCalls() {
        return toolCalls;
    }
    ...
    public static final class Builder {
        private Optional<List<ToolCall2>> toolCalls = Optional.empty();
        ...
        public Builder toolCalls(Optional<List<ToolCall2>> toolCalls) {
            this.toolCalls = toolCalls;
            return this;
        }

        public Builder toolCalls(List<ToolCall2> toolCalls) {
