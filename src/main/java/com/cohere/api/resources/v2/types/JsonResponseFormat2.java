...
@JsonDeserialize(builder = JsonResponseFormat2.Builder.class)
public final class JsonResponseFormat2 {
    private final Optional<Map<String, Object>> jsonSchema;

    private final Map<String, Object> additionalProperties;

    private JsonResponseFormat2(Optional<Map<String, Object>> jsonSchema, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof JsonResponseFormat2 && equalTo((JsonResponseFormat2) other);
    }
    ...
    private boolean equalTo(JsonResponseFormat2 other) {
    ...
    public static final class Builder {
        ...
        public Builder from(JsonResponseFormat2 other) {
        ...
        public JsonResponseFormat2 build() {
            return new JsonResponseFormat2(jsonSchema, additionalProperties);
        }
    }
}
