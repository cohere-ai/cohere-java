...
public class DatasetsClient {
    ...
    public DatasetsCreateResponse create(
        ...
        try {
            ...
            MediaType dataMediaType = dataMimeType != null ? MediaType.parse(mimeType) : null;
            body.addFormDataPart("data", data.getName(), RequestBody.create(dataMediaType, data));
            if (evalData.isPresent()) {
                String evalDataMimeType = Files.probeContentType(evalData.toPath());
                MediaType evalDataMediaType = evalDataMimeType != null ? MediaType.parse(mimeType) : null;
                body.addFormDataPart(
                        "eval_data", evalData.getName(), RequestBody.create(evalDataMediaType, evalData.get()));
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
